...
int main(int argc, char *argv[]) {
    ...
    //cout<<"source: "<<source<<"   targe: "<<target<<endl; 
    ...
    if(myrank==0)
        cout<<source<<" has been copied to /tmp/"<<base<<" on each compute node."<<endl<<"Please remember to copy the required files out of /tmp before the job finishes!"<<endl;
    MPI_Finalize();
    return 0;
